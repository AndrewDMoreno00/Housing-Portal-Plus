...
class JohnScreen extends StatefulWidget {
  const JohnScreen({super.key});

  @override
  State<JohnScreen> createState() => _JohnScreenState();
}

class _JohnScreenState extends State<JohnScreen> {
