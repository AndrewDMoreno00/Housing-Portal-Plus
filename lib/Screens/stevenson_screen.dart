...
class _StevensonScreenState extends State<StevensonScreen> {
  ...
  Future<void> fetchReviews() async {
    DatabaseReference ref = FirebaseDatabase.instance.ref("submissions/stevenson");
  ...
  Future<void> fetchImageUrls() async {
    DatabaseReference ref = FirebaseDatabase.instance.ref("images/stevenson");
    final snapshot = await ref.get();
  ...
  DatabaseReference ref = FirebaseDatabase.instance.ref("dorm/stevenson");
  final snapshot = await ref.get();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Stevenson College'),
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Text(
                '''
Stevenson College, founded in 1966, is one of UCSC's earliest colleges, located on a scenic hill with easy access to campus amenities. Its theme, "Self and Society," encourages both personal growth and community engagement. Students from diverse majors and backgrounds benefit from the two-quarter core course, dynamic faculty, and supportive staff, creating a vibrant and intellectually enriching environment.
''',
  ...
  Residential Halls - Each floor has a large central bathroom facility, with private bathroom stalls, sinks, showers, washer and dryer. Most bathrooms are designated "mixed-gender" but are modified for individual privacy. Single-gender Halls are also available.
  
  Apartments - The Stevenson Apartments are available to continuing students. Most apartments are shared by 6-7 students, with common living rooms, kitchens, dining areas, and bathrooms. Room set ups are typically a quad room or a large triple room accompanied by 3 single rooms.
  
  Stevenson Coffee House Established in 1975 and located at Stevenson College. This long-standing favorite offers espresso drinks, salads, sandwiches, their famous fudgies, and more. Slug Points, Banana Bucks, Flexi Dollars, and credit cards accepted.
            ...
            ''',
                        ...
                        TextSpan(
                          ...
                          recognizer: TapGestureRecognizer()
                            ..onTap = () async {
                              final Uri url = Uri.parse('https://stevenson.ucsc.edu/');
